...
% Uncomment to move logo to lower left
%\logo{\pgfputat{\pgfxy(-9.5,0)}{\pgfbox[center,base]
%    {\includegraphics[height=16pt]{figs/logo-jhu-bw.png}~~~~~%
%      \includegraphics[height=18pt]{figs/logo-LCSR-bw.png}~~%
%    }}}
